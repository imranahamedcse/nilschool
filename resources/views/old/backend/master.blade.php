...
<head>
    ...
    <!-- Delete alert text-->
    <input type="hidden" name="alert_title" id="alert_title" value="{{ ___('common.Are you sure?') }}">
    <input type="hidden" name="alert_subtitle" id="alert_subtitle" value="{{ ___('common.You wont be able to revert this!') }}">
    <input type="hidden" name="alert_yes_btn" id="alert_yes_btn" value="{{ ___('common.Yes, delete it!') }}">
    ...
    <link href="{{ asset('backend') }}/vendors/summernote/summernote-lite.min.css" rel="stylesheet">
...
<body class="{{ findDirectionOfLang() }} default-theme" dir="{{ @findDirectionOfLang() }}">
    ...
    <script src="{{ asset('backend') }}/assets/js/__dir.js"></script>
    ...
    {{-- Custom Js --}}
    <script src="{{ asset('backend') }}/assets/js/fees-master.js"></script>
    <script src="{{ asset('backend') }}/assets/js/custom.js"></script>


    <script src="{{ asset('backend') }}/vendors/summernote/summernote-lite.min.js"></script>
