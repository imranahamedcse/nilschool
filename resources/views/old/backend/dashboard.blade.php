    ...
    <div class="row ">
        ...
        @if (hasPermission('counter_read'))
            <div class="col-xl-3 col-lg-3 col-md-6">
                <div class="ot_crm_summeryBox2 d-flex align-items-center mb-24">
                    <div class="icon style2">
                        <img class="img-fluid" src="{{ asset('backend/assets/images/crm/4.svg') }}" alt="crm_summery1">
                    </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6">
                <div class="ot_crm_summeryBox2 d-flex align-items-center mb-24">
                    <div class="icon style3">
                        <img class="img-fluid" src="{{ asset('backend/assets/images/crm/2.svg') }}" alt="crm_summery1">
                    </div>
                    <div class="summeryContent">
                        <h4>{{ $data['parent'] }}</h4>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6">
                <div class="ot_crm_summeryBox2 d-flex align-items-center mb-24">
                    <div class="icon">
                        <img class="img-fluid" src="{{ asset('backend/assets/images/crm/3.svg') }}" alt="crm_summery1">
                    </div>
                    <div class="summeryContent">
                        <h4>{{ $data['teacher'] }}</h4>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6">
                <div class="ot_crm_summeryBox2 d-flex align-items-center mb-24">
                    <div class="icon style4">
                        <img class="img-fluid" src="{{ asset('backend/assets/images/crm/1.svg') }}" alt="crm_summery1">
                    </div>
                    <div class="summeryContent">
                        <h4>{{ $data['session'] }}</h4>
                ...
                <div class="ot-card chart-card2 ot_heightFull mb-24">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap_20">
                        <div class="card-title ">
                            <h4 class="mb-0">{{___('dashboard.Fees Collection')}} ({{ date('Y') }})</h4>
                        </div>
                    </div>
