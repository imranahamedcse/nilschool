                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <select class="nice-select bordered_style wide @error('subjects') is-invalid @enderror"
                                                                        ...
                                                                        <option {{ @$data['assignSubjects'][$key] == 1 ? 'disabled':'' }} value="">{{ ___('academic.Select subject') }}</option>
                                                                ...
                                                                <td>
                                                                    <select class="nice-select bordered_style wide @error('teachers') is-invalid @enderror"
                                                                        ...
                                                                        <option {{ @$data['assignSubjects'][$key] == 1 ? 'disabled':'' }} value="">{{ ___('academic.Select teacher') }}</option>
