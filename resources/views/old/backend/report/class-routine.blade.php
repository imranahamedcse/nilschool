...
<div class="page-content">
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="bradecrumb-title mb-1">{{ ___('settings.class_routine') }}</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">{{ ___('common.home') }}</a></li>
                        <li class="breadcrumb-item">{{ ___('settings.class_routine') }}</li>
                    </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{ route('report-class-routine.search') }}" method="post" id="marksheed" enctype="multipart/form-data">
                @csrf
            ...
            @if (@$data['result']->count() > 0)
                <div class="col-lg-12">
                    <div class="download_print_btns ">
                        ...
                        <a class="btn btn-lg ot-btn-primary" href="{{ route('report-class-routine.pdf-generate', ['class'=>$data['request']->class, 'section'=>$data['request']->section]) }}">
                                                        ...
                                                        @foreach ($data['result'][$n]->classRoutineChildren as $item)
                                                            @if ($item->time_schedule_id == $item0->time_schedule_id)
                                                                <div class="classBox_wiz">
                                                                    ...
                                                                    <p>{{___('report.Room No')}}: {{ $item->classRoom->room_no }}</p>
                                                                </div>
                                                            @endif
                                                        @endforeach
                                                    </td>
