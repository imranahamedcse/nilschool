<div class="sidebar-header">
    ...
    <button class="half-expand-toggle sidebar-toggle">
        <img class="arrow_lite" src="{{ asset('backend') }}/assets/images/icons/collapse-arrow.svg" alt="" />
        <img class="arrow_dark" src="{{ asset('backend') }}/assets/images/icons/collapse-arrow2.svg" alt="" />
    </button>
