            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('counter.index') }}">{{ $data['title'] }}</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('name') is-invalid @enderror" name="name"
                                        value="{{ old('name',@$data['counter']->name) }}" list="datalistOptions" id="exampleDataList"
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="exampleDataList" class="form-label ">{{ ___('common.Total count') }} <span
                                        class="fillable">*</span></label>
                                    <input class="form-control ot-input @error('total_count') is-invalid @enderror" name="total_count"
                                        value="{{ old('total_count',@$data['counter']->total_count) }}" list="datalistOptions" id="exampleDataList" type="number"
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="exampleDataList"
                                        class="form-label ">{{ ___('common.image') }} {{ ___('common.(65 x 75 px)') }}</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('serial') is-invalid @enderror" name="serial"
                                        value="{{ old('serial',@$data['counter']->serial) }}" list="datalistOptions" id="exampleDataList" type="number"
