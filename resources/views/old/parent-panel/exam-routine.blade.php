...
<div class="page-content">
    ...
    <div class="col-12 p-0">
        <form action="{{ route('parent-panel-exam-routine.search') }}" method="post" id="exam_routine" enctype="multipart/form-data">
            @csrf
    ...
    @if (@$data['result'])
        ...
        <div class="col-lg-12">
            <div class="download_print_btns ">
                ...
                <a class="btn btn-lg ot-btn-primary" href="{{ route('parent-panel-exam-routine.pdf-generate', ['student'=>@$request->student, 'type'=>@$request->exam_type]) }}">
