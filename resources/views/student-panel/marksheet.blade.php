...
@section('content')
    <div class="page-content">
        ...
        <div class="col-12 p-0">
            <form action="{{ route('student-panel-marksheet.search') }}" method="post" id="marksheed" enctype="multipart/form-data">
                @csrf
        ...
        @if (@$data['result'])
            <div class="col-lg-12 p-0">
                <div class="download_print_btns ">
                    ...
                    <a class="btn btn-lg ot-btn-primary" href="{{ route('student-panel-marksheet.pdf-generate', ['type'=>$data['request']->exam_type]) }}">
