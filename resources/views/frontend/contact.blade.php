        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-xl-5">
                <div class="breadcam_wrap text-center">
                    <h3>{{ ___('frontend.Contact Us') }}</h3>
                    <div class="custom_breadcam">
                        <a href="{{url('/')}}" class="breadcrumb-item">{{ ___('frontend.home') }}</a>
                        <a href="#" class="breadcrumb-item">{{ ___('frontend.Contact Us') }}</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <form class="form-area contact-form" id="myForm" method="post">
                                <div class="row">
                                    <div class="col-xl-6">
                                        ...
                                        <input name="name" placeholder="{{ ___('frontend.Enter Name') }}" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Name'" class="name primary_input mb_30" required="" type="text">
                                    </div>
                                    <div class="col-xl-6">
                                        <label class="primary_label">{{ ___('frontend.Phone no') }}</label>
                                        <input name="phone" placeholder="{{ ___('frontend.Phone no') }}" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone no'" class="phone primary_input mb_30" required="" type="text">
                                    </div>
                                    <div class="col-xl-6">
                                        <label class="primary_label">{{ ___('frontend.Email Address') }}</label>
                                        <input name="email" placeholder="{{ ___('frontend.Type e-mail address') }}" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Type e-mail address'" class="email primary_input mb_30" required="" type="email">
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <textarea class="message primary_textarea mb_30" name="message" placeholder="{{ ___('frontend.Write your message') }}" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Write your message'" required=""></textarea>
                                    </div>
                                    <div class="col-xl-12 text-left">
                                        <button type="submit" class="theme_btn submit-btn text-center d-inline-flex gap_14 align-items-center m-0">{{ ___('frontend.Send Message') }} <i class="fab fa-telegram-plane f_s_20"></i></button>
                                        {{-- mail-script.js --}}
                                    </div>
                                </div>
                            </form>
