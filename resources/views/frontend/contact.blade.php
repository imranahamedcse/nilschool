        ...
        <div class="page_items container">
            <div class="row justify-content-between">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="fw-semibold mb-2">{{ ___('frontend.Location!') }}</h6>
                            <iframe
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="fw-semibold mb-4">{{ ___('frontend.Get in touch!') }}</h6>
                            <form class="form-area contact-form" id="myForm" method="post">
                                <div class="row">
                                    <div class="col-6 mb-3">
                                        <label class="form-label fw-semibold">{{ ___('frontend.Name') }}</label>
                                        <input name="name" placeholder="{{ ___('frontend.Enter Name') }}"
                                            onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Name'"
                                            class="name form-control" required="" type="text">
                                    </div>
                                    <div class="col-6 mb-3">
                                        <label class="form-label fw-semibold">{{ ___('frontend.Phone no') }}</label>
                                    ...
                                    <div class="col-6 mb-3">
                                        <label class="form-label fw-semibold">{{ ___('frontend.Email Address') }}</label>
                                    ...
                                    <div class="col-6 mb-3">
                                        <label class="form-label fw-semibold">{{ ___('frontend.Subject') }}</label>
                                        <input name="subject" placeholder="{{ ___('frontend.Subject') }}"
                                            onfocus="this.placeholder = ''" onblur="this.placeholder = 'Subject'"
                                            class="subject form-control" required="" type="text">
                                    </div>
                                    <div class="col-12 mb-3">
                                        <label class="form-label fw-semibold">{{ ___('frontend.Message') }}</label>
