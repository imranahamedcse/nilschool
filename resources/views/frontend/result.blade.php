                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-6 mb-3">
                                            ...
                                            <select class="form-control session" name="session">
                                                <option value="" data-display="Select">{{ ___('frontend.Select') }}
                                                </option>
                                        ...
                                        <div class="col-12 col-lg-6 mb-3">
                                            <label class="form-label text-dark fw-semibold"
                                                for="#">{{ ___('frontend.Select class') }} <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-12 col-lg-6 mb-3">
                                            <label class="form-label text-dark fw-semibold"
                                                for="#">{{ ___('frontend.Select section') }} <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-12 col-lg-6 mb-3">
                                            <label class="form-label text-dark fw-semibold"
                                                for="#">{{ ___('frontend.Select Exam') }} <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-12 mb-3">
                                            <label for="exampleDataList"
                                                class="form-label text-dark fw-semibold">{{ ___('frontend.Admission no') }}
