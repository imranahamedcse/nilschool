                ...
                <div class="col-xl-4 col-lg-4 col-md-4 mb_24">
                    <div class="eventList_widget">
                        ...
                        <div class="eventList_meta">
                            ...
                            <h4>
                                <a href="{{route('frontend.events-detail',$item->id)}}">{{ $item->title }}</a>
                            </h4>
                            <p>{!! Str::limit($item->description,135) !!}</p>
