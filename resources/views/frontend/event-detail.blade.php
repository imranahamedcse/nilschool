        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-xl-8">
                <div class="breadcam_wrap text-center">
                    <h3>{{ ___('common.Event Details') }}</h3>
                    <div class="custom_breadcam">
                        <a href="{{url('/')}}" class="breadcrumb-item">{{ ___('common.home') }}</a>
                        <a href="#" class="breadcrumb-item">{{ ___('common.Event Details') }}</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-8">
                <div class="event_page_info_details mb_30">
                    <span class="event_tag">{{ ___('common.Overview') }}</span>
                    ...
                    <div class="event_wrap_location_time mb_40">
                        <h4>{{ ___('common.Event Details') }}</h4>
                        <ul>
                            <li>{{ ___('common.Start') }} : {{ dateFormat($data['event']->date) }} - {{ timeFormat($data['event']->start_time) }}</li>
                            <li>{{ $data['event']->address }}</li>
                            <li>{{ ___('common.End') }} : {{ dateFormat($data['event']->date) }} - {{ timeFormat($data['event']->end_time) }}</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-xl-4">
                <div class="news_page_right_sidebar mb_25">
                    <h4 class="font_24 f_w_400 mb_15">{{ ___('common.Upcoming Events') }}</h4>
