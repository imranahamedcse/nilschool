                ...
                <div class="search_result_print_view mb_30" id="printableArea">
                    ...
                    <div class="search_result_print_view_body">
                        <ul class="search_result_print_view_body_list">
                            <li><span class="list_title">{{ ___('common.Student Name') }} :</span> <span class="list_text">{{ @$data['classSection']->student->first_name }} {{ @$data['classSection']->student->last_name }}</span></li>
                            <li><span class="list_title">{{ ___('common.Guardian Name') }} :</span> <span class="list_text">{{ @$data['classSection']->student->parent->guardian_name }}</span></li>
                            <li><span class="list_title">{{ ___('common.DOB') }} :</span> <span class="list_text">{{ dateFormat(@$data['classSection']->student->dob) }}</span></li>
                            <li><span class="list_title">{{ ___('common.Guardian Phone') }} :</span> <span class="list_text">{{ @$data['classSection']->student->parent->guardian_mobile }}</span></li>
                            <li><span class="list_title">{{ ___('common.Class(Section)') }} :</span> <span class="list_text">{{ @$data['classSection']->class->name }} ({{ @$data['classSection']->section->name }})</span></li>
                            <li><span class="list_title">{{ ___('common.Guardian Email') }} :</span> <span class="list_text">{{ @$data['classSection']->student->parent->guardian_email }}</span></li>
                            <li><span class="list_title">{{ ___('common.Result') }} :</span> <span class="list_text">{{ @$data['result'] }}</span></li>
                            <li><span class="list_title">{{ ___('common.GPA') }} :</span>
                        ...
                        <div class="search_result_print_view_body_info_table">
                            <h4>{{ ___('common.Grade Sheet') }}</h4>
                            <div class="search_result_print_view_body_info_table_info">
                                <table class="print_table_wrapper">
                                    <thead>
                                        <tr>
                                            <th class="marked_bg">{{ ___('common.Subject Code') }}</th>
                                            <th class="marked_bg">{{ ___('common.Subject Name') }}</th>
                                            <th class="marked_bg">{{ ___('common.Grade') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                            ...
                            <div class="search_result_print_view_body_info_table_infoBtn">
                                {{-- <button class="print_btn_1" onclick="printDiv('printableArea')">{{ ___('common.Print Maksheet') }}</button> --}}
                                ...
                                <a class="print_btn_2" href="{{ route('frontend.result') }}">{{ ___('common.Search Again') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
