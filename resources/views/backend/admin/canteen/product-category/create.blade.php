...
@section('content')
    ...
    <div class="card bg-white">
        <div class="card-body">
            ...
            <form action="{{ route('product-category.store') }}" enctype="multipart/form-data" method="post" id="visitForm">
                @csrf
                <div class="row mb-3">
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select
                                    ...
                                    <option value="{{ App\Enums\Status::ACTIVE }}" selected>{{ ___('create.active') }}
                                    </option>
                                    <option value="{{ App\Enums\Status::INACTIVE }}"
                                        {{ old('name') && old('status') == App\Enums\Status::INACTIVE ? 'selected' : '' }}>
                                        {{ ___('create.inactive') }}
                                    </option>
                                </select>
                                @error('status')
