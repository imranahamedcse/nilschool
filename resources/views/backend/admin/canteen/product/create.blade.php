...
@section('content')
    ...
    <div class="card bg-white">
        <div class="card-body">
            ...
            <form action="{{ route('product.store') }}" enctype="multipart/form-data" method="post" id="visitForm">
                @csrf
                <div class="row mb-3">
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control @error('sku') is-invalid @enderror" name="sku"
                                    value="{{ old('sku') }}" id="validationDefault03"
                                    placeholder="{{ ___('create.enter_sku') }}">
                                @error('sku')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
