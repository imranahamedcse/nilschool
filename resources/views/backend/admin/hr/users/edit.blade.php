                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <input class="form-control @error('staff_id') is-invalid @enderror" name="staff_id"
                                ...
                                id="validationDefault01" type="number" placeholder="{{ ___('staff.enter_staff_id') }}">
                            @error('staff_id')
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <input class="form-control @error('first_name') is-invalid @enderror" name="first_name"
                                ...
                                id="validationDefault05" placeholder="{{ ___('staff.enter_first_name') }}">
                            @error('first_name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <input class="form-control @error('last_name') is-invalid @enderror" name="last_name"
                                ...
                                id="validationDefault06" placeholder="{{ ___('staff.enter_last_name') }}">
                            @error('last_name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <input class="form-control @error('phone') is-invalid @enderror" name="phone"
                                ...
                                id="validationDefault13" placeholder="{{ ___('staff.enter_phone') }}">
                            @error('phone')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <label for="validationDefault14" class="form-label ">{{ ___('staff.emergency_contact') }}
                            </label>
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <label for="validationDefault19" class="form-label ">{{ ___('staff.permanent_address') }}
                            </label>
