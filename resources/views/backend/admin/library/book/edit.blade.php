                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control @error('code') is-invalid @enderror" name="code"
                                    ...
                                    id="validationDefault03" placeholder="{{ ___('create.enter_code') }}">
                                @error('code')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control @error('publisher_name') is-invalid @enderror"
                                    ...
                                    placeholder="{{ ___('create.enter_publisher_name') }}">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control @error('author_name') is-invalid @enderror"
                                    ...
                                    placeholder="{{ ___('create.enter_author_name') }}">
                                @error('author_name')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control @error('rack_no') is-invalid @enderror" name="rack_no"
                                    ...
                                    id="validationDefault06" type="number" placeholder="{{ ___('create.enter_rack_no') }}">
                                @error('rack_no')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
