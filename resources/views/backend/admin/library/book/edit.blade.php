            ...
            <form action="{{ route('book.update', @$data['book']->id) }}" enctype="multipart/form-data" method="post"
                ...
                <div class="row mb-3">
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-4">
                                <label for="validationDefault01" class="form-label">{{ ___('common.Book category') }} <span
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="validationDefault03" class="form-label ">{{ ___('common.code') }} <span
                                        class="text-danger">*</span></label>
                                <input class="form-control @error('code') is-invalid @enderror" name="code"
                                    value="{{ old('code', @$data['book']->code) }}"
                                    id="validationDefault03" placeholder="{{ ___('common.enter_code') }}">
                                @error('code')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="validationDefault04" class="form-label ">{{ ___('common.publisher_name') }} <span
                                        class="text-danger">*</span></label>
                                <input class="form-control @error('publisher_name') is-invalid @enderror"
                                    name="publisher_name"
                                    value="{{ old('publisher_name', @$data['book']->publisher_name) }}"
                                    id="validationDefault04"
                                    placeholder="{{ ___('common.enter_publisher_name') }}">
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="validationDefault05" class="form-label ">{{ ___('common.author_name') }} <span
                                        class="text-danger">*</span></label>
                                <input class="form-control @error('author_name') is-invalid @enderror"
                                    ...
                                    placeholder="{{ ___('common.enter_author_name') }}">
                                @error('author_name')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="validationDefault06" class="form-label ">{{ ___('common.rack_no') }} <span
                                        class="text-danger">*</span></label>
                                <input class="form-control @error('rack_no') is-invalid @enderror" name="rack_no"
                                    value="{{ old('rack_no', @$data['book']->rack_no) }}"
                                    id="validationDefault06" type="number" placeholder="{{ ___('common.enter_rack_no') }}">
                                @error('rack_no')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="validationDefault07" class="form-label ">{{ ___('common.price') }} <span
                                        class="text-danger">*</span></label>
                                <input class="form-control @error('price') is-invalid @enderror" name="price"
                                    type="number" value="{{ old('price', @$data['book']->price) }}"
                                    id="validationDefault07" placeholder="{{ ___('common.enter_price') }}">
                                @error('price')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="validationDefault08" class="form-label ">{{ ___('common.quantity') }} <span
                                        class="text-danger">*</span></label>
                                <input class="form-control @error('quantity') is-invalid @enderror"
                                    name="quantity" type="number"
                                    value="{{ old('quantity', @$data['book']->quantity) }}"
                                    id="validationDefault08" placeholder="{{ ___('common.enter_quantity') }}">
                                @error('quantity')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <label for="validationDefault10" class="form-label">{{ ___('common.description') }}</label>
