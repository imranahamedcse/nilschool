                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control @error('code') is-invalid @enderror" name="code"
                                    ...
                                    placeholder="{{ ___('common.enter_code') }}">
                                @error('code')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control @error('publisher_name') is-invalid @enderror"
                                    ...
                                    id="validationDefault04" placeholder="{{ ___('common.enter_publisher_name') }}">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control @error('author_name') is-invalid @enderror"
                                    ...
                                    id="validationDefault05" placeholder="{{ ___('common.enter_author_name') }}">
                                @error('author_name')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control @error('rack_no') is-invalid @enderror" name="rack_no"
                                    ...
                                    placeholder="{{ ___('common.enter_rack_no') }}">
                                @error('rack_no')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control @error('price') is-invalid @enderror" name="price"
                                    ...
                                    placeholder="{{ ___('common.enter_price') }}">
                                @error('price')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
