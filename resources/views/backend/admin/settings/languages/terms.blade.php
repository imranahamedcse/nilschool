        ...
        <form action="{{ route('languages.update.terms', @$data['language']->code) }}" enctype="multipart/form-data"
            ...
            <div class="row mb-3">
                <div class="col-md-12 mb-3">
                    <label for="validationDefault01" class="form-label">{{ ___('common.module') }}</label>
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label class="form-label ">{{ ___('common.term') }}</label>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label ">{{ ___('common.translated_language') }}</label>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 translated_language">
                                <input class="form-control"
                                    placeholder="{{ ___('common.translated_language') }}" name="{{ $key }}"
                                    value="{{ $row }}">
                            </div>
                        </div>
                    @endforeach
