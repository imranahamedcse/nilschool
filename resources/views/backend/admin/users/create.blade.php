                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        ...
                        <input class="form-control ot-input @error('staff_id') is-invalid @enderror" name="staff_id"
                            value="{{ old('staff_id') }}" list="datalistOptions" id="exampleDataList" type="number"
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        ...
                        <input class="form-control ot-input @error('first_name') is-invalid @enderror" name="first_name"
                            value="{{ old('first_name') }}" list="datalistOptions" id="exampleDataList"
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        ...
                        <input class="form-control ot-input @error('last_name') is-invalid @enderror" name="last_name"
                            value="{{ old('last_name') }}" list="datalistOptions" id="exampleDataList"
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        ...
                        <input class="form-control ot-input @error('father_name') is-invalid @enderror" name="father_name"
                            value="{{ old('father_name') }}" list="datalistOptions" id="exampleDataList"
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        ...
                        <input class="form-control ot-input @error('mother_name') is-invalid @enderror" name="mother_name"
                            value="{{ old('mother_name') }}" list="datalistOptions" id="exampleDataList"
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}"
                            class="form-control ot-input  @error('email') is-invalid @enderror" id="exampleInputEmail1"
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        ...
                        <input class="form-control ot-input @error('dob') is-invalid @enderror" name="dob"
                            value="{{ old('dob') }}" list="datalistOptions" id="exampleDataList" type="date"
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        ...
                        <input class="form-control ot-input @error('joining_date') is-invalid @enderror"
                            name="joining_date" value="{{ old('joining_date') }}" list="datalistOptions"
                            id="exampleDataList" type="date" placeholder="{{ ___('staff.enter_joining_date') }}">
                        @error('joining_date')
                            <div id="validationServer04Feedback" class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        ...
                        <input class="form-control ot-input @error('emergency_contact') is-invalid @enderror"
                            name="emergency_contact" value="{{ old('emergency_contact') }}" list="datalistOptions"
                            id="exampleDataList" placeholder="{{ ___('staff.enter_emergency_contact') }}">
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        <label class="form-label" for="inputImage">{{ ___('common.image') }}
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        ...
                        <input class="form-control ot-input @error('current_address') is-invalid @enderror"
                            name="current_address" value="{{ old('current_address') }}" list="datalistOptions"
                            id="exampleDataList" placeholder="{{ ___('staff.enter_current_address') }}">
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        ...
                        <input class="form-control ot-input @error('permanent_address') is-invalid @enderror"
                            name="permanent_address" value="{{ old('permanent_address') }}" list="datalistOptions"
                            id="exampleDataList" placeholder="{{ ___('staff.enter_permanent_address') }}">
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        ...
                        <input class="form-control ot-input @error('basic_salary') is-invalid @enderror"
                            name="basic_salary" value="{{ old('basic_salary') }}" list="datalistOptions"
                            id="exampleDataList" type="number" placeholder="{{ ___('staff.enter_basic_salary') }}">
                        @error('basic_salary')
                            <div id="validationServer04Feedback" class="invalid-feedback">
                                {{ $message }}
                            </div>
