                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <input class="form-control ot-input @error('last_name') is-invalid @enderror" name="last_name"
                                value="{{ old('last_name', @$data['user']->last_name) }}" list="datalistOptions"
                                id="exampleDataList" placeholder="{{ ___('staff.enter_last_name') }}">
                            @error('last_name')
                                <div id="validationServer04Feedback" class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <label for="exampleDataList" class="form-label ">{{ ___('staff.emergency_contact') }}
                            </label>
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <select
                                ...
                                <option
                                    ...
                                    value="{{ App\Enums\MaritalStatus::UNMARRIED }}">{{ ___('staff.unmarried') }}
                                </option>
                                <option
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <label for="exampleDataList" class="form-label ">{{ ___('staff.permanent_address') }}
                            </label>
                                                ...
                                                <td class="w-100 mw-50">
                                                    <div class="school_primary_fileUplaoder mb-3">
                                                        ...
                                                        <input type="text" class="redonly_input" readonly
                                                            placeholder="{{ ___('staff.Upload Documents') }}">
                                                    </div>
                                                </td>
                                                <td>
