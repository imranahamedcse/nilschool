                ...
                <div class="row mb-3">
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="validationDefault04" class="form-label">{{ ___('create.Route') }} <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="validationDefault05" class="form-label">{{ ___('create.Vehicle') }} <span
                                        class="text-danger">*</span></label>
                                <select id="validationDefault05" class="vehicle form-control @error('vehicle') is-invalid @enderror" name="vehicle">
                                    <option value="">{{ ___('create.Select vehicle') }} </option>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="validationDefault06" class="form-label">{{ ___('create.Pickup point') }} <span
                                        class="text-danger">*</span></label>
                                <select id="validationDefault06" class="pickup_point form-control @error('pickup_point') is-invalid @enderror"
                                    name="pickup_point">
                                    <option value="">{{ ___('create.Select pickup point') }} </option>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="validationDefault07" class="form-label ">{{ ___('create.Note') }}</label>
                                <input class="form-control" name="note" id="validationDefault07"
                                    placeholder="{{ ___('create.Enter note') }}" value="{{ old('note') }}">
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="validationDefault08" class="form-label">{{ ___('create.Status') }} <span
                                        class="text-danger">*</span></label>
