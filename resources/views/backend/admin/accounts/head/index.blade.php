            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if (hasPermission('account_head_create'))
                        <a href="{{ route('account_head.create') }}" class="btn btn-lg ot-btn-primary">
                        ...
                        <table class="table table-bordered class-table">
                            ...
                            <tbody class="tbody">
                                ...
                                <tr id="row_{{ $row->id }}">
                                    ...
                                    @if ((hasPermission('account_head_update') || hasPermission('account_head_delete')) && $row->id != 1)
                                        <td class="action">
                                                    ...
                                                    @if (hasPermission('account_head_update'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('account_head.edit', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                    ...
                                                    @if (hasPermission('account_head_delete'))
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:void(0);"
                                                                onclick="delete_row('account_head/delete', {{ $row->id }})">
