                                    ...
                                    <td>
                                        @if (hasPermission('question_bank_update'))
                                            <a class="btn btn-sm btn-secondary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ ___('common.edit') }}"
                                                href="{{ route('question-bank.edit', $row->id) }}"><i class="fa-solid fa-pencil"></i></a>
                                        @endif
                                        @if (hasPermission('question_bank_delete') && $row->code != 'en')
                                            ...
                                            href="javascript:void(0);" onclick="delete_row('question-bank/delete', {{ $row->id }})"><i class="fa-solid fa-trash-can"></i></a>
                                        @endif
                                    </td>
