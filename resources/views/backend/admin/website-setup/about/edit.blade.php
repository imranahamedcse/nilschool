            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('about.index') }}">{{ $data['title'] }}</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control ot-input @error('name') is-invalid @enderror" name="name"
                                        value="{{ old('name',@$data['about']->name) }}" list="datalistOptions" id="exampleDataList"
                                ...
                                <div class="col-md-6">
                                    <label for="exampleDataList"
                                        class="form-label ">{{ ___('common.image') }} {{ ___('common.(715 x 575 px)') }}</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control ot-input @error('serial') is-invalid @enderror" name="serial"
                                        value="{{ old('serial',@$data['about']->serial) }}" list="datalistOptions" id="exampleDataList" type="number"
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    placeholder="{{ ___('common.Enter description') }}">{{ old('description',@$data['about']->description) }}</textarea>
                                    @error('description')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
