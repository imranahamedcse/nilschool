                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a
                                href="{{ route('about.index') }}">{{ ___('settings.about') }}</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label for="exampleDataList"
                                        class="form-label ">{{ ___('common.image') }} {{ ___('common.(715 x 575 px)') }}<span
                                            class="fillable">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <label for="exampleDataList"
                                        class="form-label ">{{ ___('common.Icon') }} {{ ___('common.(60 x 60 px)') }}<span
                                            class="fillable">*</span></label>
                                    <div class="ot_fileUploader left-side mb-3 @error('icon') is-invalid @enderror">
                                        <input class="form-control" type="text"
