                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a
                                href="{{ route('contact-info.index') }}">{{ $data['title'] }}</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('address') is-invalid @enderror" name="address"
                                        value="{{ old('address') }}" list="datalistOptions" id="exampleDataList" type="text"
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="exampleDataList"
                                        class="form-label ">{{ ___('common.image') }} {{ ___('common.(65 x 90 px)') }}<span
                                            class="fillable">*</span></label>
