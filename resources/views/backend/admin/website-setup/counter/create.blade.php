                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a
                                href="{{ route('counter.index') }}">{{ $data['title'] }}</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('total_count') is-invalid @enderror" name="total_count"
                                        value="{{ old('total_count') }}" list="datalistOptions" id="exampleDataList" type="number"
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="exampleDataList"
                                        class="form-label ">{{ ___('common.image') }} {{ ___('common.(65 x 75 px)') }}<span
                                            class="fillable">*</span></label>
