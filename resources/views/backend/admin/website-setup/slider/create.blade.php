                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="validationDefault02" class="form-label ">{{ ___('common.image') }}
                                    {{ ___('common.(1920 x 890 px)') }}<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="validationDefault06" class="form-label ">{{ ___('common.Serial') }} <span
                                        class="text-danger"> *</span></label>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" name="description"
                                    id="validationDefault07" placeholder="{{ ___('common.Enter description') }}">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
