                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input class="form-control @error('address') is-invalid @enderror" name="address"
                                    ...
                                    id="validationDefault04" placeholder="{{ ___('common.enter_address') }}">
                                @error('address')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input class="form-control @error('end_time') is-invalid @enderror" name="end_time"
                                    ...
                                    id="validationDefault06" type="time" placeholder="{{ ___('common.enter_end_time') }}">
                                @error('end_time')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" name="description"
                                    id="validationDefault08" placeholder="{{ ___('common.Enter description') }}">{{ old('description', @$data['event']->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
