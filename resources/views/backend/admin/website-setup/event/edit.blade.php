                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('title') is-invalid @enderror" name="title"
                                        value="{{ old('title',@$data['event']->title) }}" list="datalistOptions" id="exampleDataList"
                                ...
                                <div class="col-md-6">
                                    <label for="exampleDataList"
                                        class="form-label ">{{ ___('common.image') }} {{ ___('common.(815 x 500 px)') }}</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('date') is-invalid @enderror" name="date"
                                        value="{{ old('date',@$data['event']->date) }}" list="datalistOptions" id="exampleDataList" type="date"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('address') is-invalid @enderror" name="address"
                                        value="{{ old('address',@$data['event']->address) }}" list="datalistOptions" id="exampleDataList"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('start_time') is-invalid @enderror" name="start_time"
                                        value="{{ old('start_time',@$data['event']->start_time) }}" list="datalistOptions" id="exampleDataList" type="time"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('end_time') is-invalid @enderror" name="end_time"
                                        value="{{ old('end_time',@$data['event']->end_time) }}" list="datalistOptions" id="exampleDataList" type="time"
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    placeholder="{{ ___('common.Enter description') }}">{{ old('description',@$data['event']->description) }}</textarea>
                                    @error('description')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
