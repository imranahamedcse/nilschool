                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input class="form-control @error('title') is-invalid @enderror" name="title"
                            ...
                            placeholder="{{ ___('create.enter_title') }}">
                        @error('title')
                    ...
                    <div class="col-md-6">
                        <label for="validationDefault02" class="form-label ">{{ ___('create.image') }}
                            {{ ___('create.(815 x 500 px)') }}<span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input class="form-control @error('address') is-invalid @enderror" name="address"
                            ...
                            placeholder="{{ ___('create.enter_address') }}">
                        @error('address')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" name="description"
                            id="validationDefault08" placeholder="{{ ___('create.Enter description') }}">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
