            ...
            <form action="{{ route('online-admissions.store') }}" enctype="multipart/form-data" method="post" id="visitForm">
                ...
                <div class="row mb-3">
                    <div class="col-lg-12">
                        ...
                        <h4 class="text-info">{{ ___('create.Student Information') }}</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input class="form-control @error('roll_no') is-invalid @enderror" name="roll_no"
                                    ...
                                    placeholder="{{ ___('create.enter_roll_no') }}"
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input class="form-control @error('mobile') is-invalid @enderror" name="mobile"
                                    ...
                                    placeholder="{{ ___('create.enter_mobile') }}"
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input class="form-control @error('email') is-invalid @enderror" name="email"
                                    ...
                                    placeholder="{{ ___('create.enter_email') }}"
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="date" class="form-control @error('date_of_birth') is-invalid @enderror"
                                    ...
                                    placeholder="{{ ___('create.date_of_birth') }}"
                            ...
                            <div class="col-md-3">
                                ...
                                <label for="validationDefault17" class="form-label">{{ ___('create.status') }} <span
                                        class="text-danger">*</span></label>
                                <select class="form-control @error('status') is-invalid @enderror" name="status"
                                    id="validationDefault17">
                                    <option {{ @$data['student']->status == App\Enums\Status::ACTIVE ? 'selected' : '' }}
                                        value="{{ App\Enums\Status::ACTIVE }}">{{ ___('create.active') }}
                                    </option>
                        ...
                        <h4 class="text-info">{{ ___('create.Parent Information') }}</h4>
                        {{-- father --}}
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input class="form-control @error('father_name') is-invalid @enderror" name="father_name"
                                    id="validationDefault18" placeholder="{{ ___('create.enter_father_name') }}"
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <label class="form-label" for="inputImage">{{ ___('create.father_image') }}
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input class="form-control @error('mother_name') is-invalid @enderror" name="mother_name"
                                    id="validationDefault21" placeholder="{{ ___('create.enter_mother_name') }}"
                            ...
                            <div class="col-md-3 mb-3">
                                <label for="validationDefault22"
                                    class="form-label ">{{ ___('create.mother_mobile') }}
                                    <span class="text-danger"></span></label>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <label class="form-label"
                                    for="validationDefault24">{{ ___('create.mother_image') }}
                                    {{ ___('create.(95 x 95 px)') }}</label>
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <label for="validationDefault25"
                                    class="form-label ">{{ ___('create.guardian_name') }}
                                    <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <label class="form-label"
                                    for="validationDefault28">{{ ___('create.guardian_image') }}
                                    {{ ___('create.(95 x 95 px)') }}</label>
                            ...
                            <div class="col-md-3">
                                ...
                                <label for="validationDefault32" class="form-label">{{ ___('create.status') }}
                                    <span class="text-danger">*</span></label>
                                <select class="form-control @error('status') is-invalid @enderror" name="status"
