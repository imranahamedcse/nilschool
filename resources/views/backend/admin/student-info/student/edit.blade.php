                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('roll_no') is-invalid @enderror"
                                        ...
                                        placeholder="{{ ___('student_info.enter_roll_no') }}" value="{{ old('roll_no',@$data['session_class_student']->roll) }}">
                                    @error('roll_no')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('mobile') is-invalid @enderror"
                                        ...
                                        placeholder="{{ ___('student_info.enter_mobile') }}" value="{{ old('mobile',@$data['student']->mobile) }}">
                                    @error('mobile')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id="getSections"
                                        ...
                                        @foreach ($data['classes'] as $item)
                                            <option {{ @$data['session_class_student']->classes_id == $item->class->id ? 'selected':''}} value="{{ $item->class->id }}">{{ $item->class->name }}
                                        @endforeach
                                        </option>
                                    </select>
                                    @error('class')
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id="getSections"
                                        ...
                                        @foreach ($data['sections'] as $item)
                                            <option {{ @$data['session_class_student']->section_id == $item->section->id ? 'selected':''}} value="{{ $item->section->id }}">{{ $item->section->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('section')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select
                                        ...
                                        @foreach ($data['shifts'] as $item)
                                            <option {{ @$data['student']->session_class_student->shift->id == $item->id ? 'selected':''}} value="{{ $item->id }}">{{ $item->name }}
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex align-items-center gap-4 flex-wrap">
                                        ...
                                        <button type="button" class="btn btn-lg ot-btn-primary radius_30px small_add_btn addNewDocument"
                                            ...
                                            <input type="hidden" name="counter" id="counter" value="{{count(@$data['student']->upload_documents)}}">
                                    </div>
                                </div>
                            </div>
