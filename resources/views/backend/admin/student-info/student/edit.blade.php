                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <label for="validationDefault18" class="form-label">{{ ___('create.status') }} <span
                                        class="text-danger">*</span></label>
