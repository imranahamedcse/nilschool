                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <label for="validationDefault01" class="form-label ">{{ ___('create.father_name') }}
                                    <span class="text-danger"></span></label>
                                <input class="form-control @error('father_name') is-invalid @enderror"
                                    name="father_name" id="validationDefault01"
                                    placeholder="{{ ___('create.enter_father_name') }}" type="text"
                            ...
                            <div class="col-md-3 mb-3">
                                <label for="validationDefault02" class="form-label ">{{ ___('create.father_mobile') }}
                                    <span class="text-danger"></span></label>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <label class="form-label" for="validationDefault04">{{ ___('create.father_image') }}
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <label for="validationDefault05" class="form-label ">{{ ___('create.mother_name') }}
                                    <span class="text-danger"></span></label>
                                <input class="form-control @error('mother_name') is-invalid @enderror"
                                    name="mother_name" id="validationDefault05"
                                    placeholder="{{ ___('create.enter_mother_name') }}" type="text"
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <label class="form-label" for="validationDefault08">{{ ___('create.mother_image') }}
                                    {{ ___('create.(95 x 95 px)') }}</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <label class="form-label" for="validationDefault12">{{ ___('create.guardian_image') }}
                                    {{ ___('create.(95 x 95 px)') }}</label>
