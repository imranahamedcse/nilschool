                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('name') is-invalid @enderror" name="name"
                                        value="{{ old('name',@$data['fees_collect']->name) }}" list="datalistOptions" id="exampleDataList" type="text"
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="exampleDataList" class="form-label ">{{ ___('fees.code') }}<span
                                        class="text-danger">*</span></label>
                                    <input class="form-control ot-input @error('code') is-invalid @enderror" name="code"
                                        value="{{ old('code',@$data['fees_collect']->code) }}" list="datalistOptions" id="exampleDataList" type="text"
                                        placeholder="{{ ___('fees.enter_code') }}">
                                    @error('code')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    placeholder="{{ ___('fees.enter_description') }}">{{ old('description',@$data['fees_collect']->description) }}</textarea>
                                    @error('description')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
