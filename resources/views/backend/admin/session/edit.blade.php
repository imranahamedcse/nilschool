            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('sessions.index') }}">{{ $data['title'] }}</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('name') is-invalid @enderror" name="name"
                                        value="{{ old('name',@$data['session']->name) }}" list="datalistOptions" id="exampleDataList"
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="exampleDataList" class="form-label ">{{ ___('common.start_date') }} <span
                                            class="fillable">*</span></label>
                                    <input type="date" class="form-control ot-input @error('start_date') is-invalid @enderror" name="start_date"
                                        list="datalistOptions" id="exampleDataList"
                                        placeholder="{{ ___('common.enter_start_date') }}" value="{{ old('start_date',@$data['session']->start_date) }}">
                                    @error('start_date')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="exampleDataList" class="form-label ">{{ ___('common.end_date') }} <span
                                            class="fillable">*</span></label>
                                    <input type="date" class="form-control ot-input @error('end_date') is-invalid @enderror" name="end_date"
                                        list="datalistOptions" id="exampleDataList"
                                        placeholder="{{ ___('common.enter_end_date') }}" value="{{ old('end_date',@$data['session']->end_date) }}">
                                    @error('end_date')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
