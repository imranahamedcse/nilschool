...
@section('content')
    <div class="page-content">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="bradecrumb-title mb-1">{{ ___('settings.marksheet') }}</h1>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">{{ ___('common.home') }}</a></li>
                            <li class="breadcrumb-item">{{ ___('settings.marksheet') }}</li>
                        </ol>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <form action="{{ route('marksheet.search') }}" method="post" id="marksheet" enctype="multipart/form-data">
                    @csrf
            ...
            @if (@$data['resultData'])
                <div class="col-lg-12">
                    <div class="download_print_btns ">
                        ...
                        <a class="btn btn-primary" href="{{ route('report-marksheet.pdf-generate', ['id'=>$data['request']->student, 'type'=>$data['request']->exam_type, 'class'=>$data['request']->class, 'section'=>$data['request']->section ]) }}">
                            ...
                            <div class="routine_wrapper_body">
                                <div class="student_info_wrapper">
                                    <div class="student_info_single">
                                        <span>{{___('student_info.Student Name')}} :</span>
                                        <h5>{{ @$data['student']->first_name }} {{ @$data['student']->last_name }}</h5>
                                    </div>
                                    <div class="student_info_single">
                                        <span>{{___('report.Guardian Name')}} :</span>
                                    ...
                                    <div class="student_info_single">
                                        <span>{{___('report.Guardian Phone')}} :</span>
                                    ...
                                    <div class="student_info_single">
                                        <span>{{___('report.Guardian Email')}} :</span>
