...
<div class="page-content">
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="bradecrumb-title mb-1">{{ ___('settings.Fees collection') }}</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">{{ ___('common.home') }}</a></li>
                        <li class="breadcrumb-item">{{ ___('settings.Fees collection') }}</li>
                    </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{ route('fees-collection.search') }}" method="post" id="marksheed" enctype="multipart/form-data">
                @csrf
