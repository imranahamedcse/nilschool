                        ...
                        <div class="card mb-4">
                            <div class="card-body my-5 mx-4 text-body-secondary">
                                <div class="mb-4 text-center">
                                    <h5><strong>{{ ___('auth.Sign Up') }}</strong></h5>
                                    <span class="small">{{ ___('auth.welcome_to_join_us') }},
                                        {{ setting('application_name') }}</span>
                                </div>


                                <form class="small" action="{{ route('register') }}" method="post">
                                    @csrf

                                    <div class="col-12 mb-3">
                                        <label for="name" class="form-label"><strong>{{ ___('auth.name') }}</strong></label>
                                        <input placeholder="{{ ___('auth.enter_your_name') }}" type="text"
                                            class="form-control @error('name') is-invalid @enderror" name="name"
                                            id="name" aria-describedby="nameValidationMsg"
                                    ...
                                    <div class="col-12 mb-3">
                                        <label for="email" class="form-label"><strong>{{ ___('auth.email') }}</strong></label>
                                    ...
                                    <div class="col-12 mb-3">
                                        <label for="phone" class="form-label"><strong>{{ ___('auth.phone') }}</strong></label>
                                        <input placeholder="{{ ___('auth.enter_your_phone') }}" type="text"
                                            class="form-control @error('phone') is-invalid @enderror" name="phone"
                                            id="phone" aria-describedby="phoneValidationMsg"
                                    ...
                                    <div class="col-12 mb-3">
                                        <label for="password" class="form-label"><strong>{{ ___('auth.password') }}</strong></label>
                                        <div class="input-group password-inpu">
                                    ...
                                    <div class="col-12 mb-3">
                                        <label for="confirm_password" class="form-label"><strong>{{ ___('auth.confirm_password') }}</strong></label>
                                    ...
                                    <div class="form-check mb-4">
                                        ...
                                        <label class="form-check-label"
                                            for="agree">{{ ___('auth.i_agree_to_terms_condition_&_privacy_policy') }}</strong></label>
                                    </div>

                                    <div class="d-grid mb-4">
                                        <button type="submit" class="btn btn-primary">
                                            {{ ___('auth.create_account') }}
                                        </button>
                                    </div>
                                </form>
                                ...
                                <div class="d-flex justify-content-center small">
                                    ...
                                    <a class="link-underline link-underline-opacity-0"
                                        href="{{ route('login') }}">{{ ___('auth.sign_in') }}</a>
                                </div>
