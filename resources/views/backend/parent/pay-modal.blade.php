...
<div class="modal-content" id="modalWidth">
    ...
    <form action="{{ route('parent-panel-fees.pay-with-stripe') }}" method="POST" id="checkout-form">
        ...
        <div class="modal-footer">
            ...
            <a href="{{ route('parent-panel-fees.pay-with-paypal') }}?fees_assign_children_id={{ $feeAssignChildren->id }}" class="btn ot-btn-primary d-none" id='paypal-pay-btn'>{{ ___('index.confirm') }}</a>
        </div>
    </form>
</div>
