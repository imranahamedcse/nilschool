                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="px-3">
                                    <span class="text-body-secondary">{{ ___('index.Total class') }}</span>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="px-3">
                                    <span class="text-body-secondary">{{ ___('index.Total subject') }}</span>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="px-3">
                                    <span class="text-body-secondary">{{ ___('index.Total teacher') }}</span>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="px-3">
                                    <span class="text-body-secondary">{{ ___('index.Total event') }}</span>
...
@push('script')
    ...
    <script>
        ...
        $.ajax({
            ...
            url: '/parent-panel/marksheet/result',
