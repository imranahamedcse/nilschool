            ...
            <div class="d-flex flex-column flex-lg-row gap-4 gap-lg-0">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img class="img-fluid rounded-circle"
                                                src="{{ @globalAsset(Auth::user()->upload->path, '40X40.webp') }}"
                                                alt="{{ Auth::user()->name }}">
                                        </div>
                ...
                <div class="profile-menu">
                    ...
                    <div class="profile-menu-head">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img class="img-fluid rounded-circle" src="{{ @globalAsset(Auth::user()->upload->path, '40X40.webp') }}"
                                    alt="{{ Auth::user()->name }}">
                            </div>
                            <div class="flex-grow-1">
                                <div class="body">
                ...
                <div class="profile-body">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h2 class="title">{{ ___('common.profile') }}</h2>
                        <a href="{{ route('student-panel.profile.edit') }}" class="btn btn-lg ot-btn-primary mb-5">
                        ...
                        <div class="form-item">
                            <div class="d-flex justify-content-between align-content-center">
                                <div class="align-self-center">
                                    ...
                                    <p class="paragraph">{{ dateFormat(Auth::user()->date_of_birth) }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="form-item">
