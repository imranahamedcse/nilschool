    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="download_print_btns ">
                ...
                <a class="btn btn-lg ot-btn-primary" href="{{ route('student-panel-class-routine.pdf-generate') }}">
            ...
            <div class="routine_wrapper" id="printableArea">
                ...
                <div class="routine_wrapper_header">
                    ...
                    <div class="routine_wrapper_header_content">
                        <h3>{{ ___('settings.class_routine') }}</h3>
                    </div>
                </div>
                    ...
                    <table class="table border_table mb_30">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @foreach ($data['time'] as $key=>$item)
                                @php
                                ++$key;
                                @endphp
                                <td>
                                    @foreach ($data['result'][$n]->classRoutineChildren as $item)
                                    @if ($item->time_schedule_id == $key)
