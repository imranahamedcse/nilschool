    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-12 p-0">
                <form action="{{ route('student-panel-attendance.search') }}" method="post" id="marksheed" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div
                                ...
                                <div class="single_large_selectBox">
                                    <select class="class nice-select niceSelect bordered_style wide" name="view">
                                        <option {{ old('view', @$data['request']->view) == '0' ? 'selected' : '' }} value="0">{{ ___('report.Short view') }}</option>
                                        <option {{ old('view', @$data['request']->view) == '1' ? 'selected' : '' }} value="1">{{ ___('report.Details view') }}</option>
                                    </select>
                                </div>
                                <div class="single_large_selectBox">
                                    <input value="{{ old('month', @$data['request']->month) }}" name="month" class="form-control ot-input @error('month') is-invalid @enderror" type="month" placeholder="Search month" min="2023-01" max="2023-12">
            ...
            <div class="table-content table-basic mt-20">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">{{ ___('report.Attendance report') }}</h4>
                        <div>
                            <small>
