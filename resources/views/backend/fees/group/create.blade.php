...
@section('content')
    <div class="page-content">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a
                                href="{{ route('fees-group.index') }}">{{ $data['title'] }}</a></li>
        ...
        <div class="card ot-card">
            <div class="card-body">
                <form action="{{ route('fees-group.store') }}" enctype="multipart/form-data" method="post" id="visitForm">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="exampleDataList" class="form-label mb-0">{{ ___('fees.description') }}</label>
