...
class ExamAssignRepository implements ExamAssignInterface
{
    ...
    public function getSubjects($request)
    {
        ...
        // 2nd section select then works it
            ...
            $old_subjects = SubjectAssignChildren::where('subject_assign_id', @$old_result->id)->pluck('subject_id')->toArray();
            ...
            $current_subjects = SubjectAssignChildren::where('subject_assign_id', @$current_result->id)->pluck('subject_id')->toArray();
